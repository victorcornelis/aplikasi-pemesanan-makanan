...
!function($) {"use strict";// jshint ;_;
    ...
    Multiselect.prototype = {
        ...
        defaults : {
            ...
            buttonWidth : 'auto',
            buttonContainer : '<div class="btn-group btn-block marginbut" />',
        ...
        buildFilter: function() {
            $('.multiselect-container', this.$container).prepend('<div class="input-group marginbut"><span class="input-group-addon radiusless"><i class="glyphicon glyphicon-search"></i></span><input class="multiselect-search radiusless" type="text" placeholder="' + this.options.filterPlaceholder + '"></div>');
